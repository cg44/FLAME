...
void
free_modeldata (model_data * modeldata)
{
...
input_file *
add_input_file (input_file ** p_files)
{
...
void
free_input_files (input_file ** p_files)
{
...
void
add_sync_pointer (sync_pointer ** p_sync_pointers, sync * current_sync)
{
...
void
free_sync_pointers (sync_pointer ** p_sync_pointers)
{
...
xmachine_ioput *
addioput (xmachine_ioput ** p_ioput)
{
...
void
free_ioput (xmachine_ioput ** p_ioput)
{
 ...
 */
env_func *
addenvfunc (env_func ** p_env_funcs)
{
 ...
 */
void
freeenvfunc (env_func ** p_env_funcs)
{
  env_func *temp, *head;
  head = *p_env_funcs;
 ...
 */
xmachine_message *
addxmessage (xmachine_message ** p_xmessage)
{
  ...
  /* And current is the new element */
  if ((current =
       (xmachine_message *) malloc (sizeof (xmachine_message))) == NULL)
    {
      printf ("Error: Cannot allocate memory\n");
      exit (0);
    }
...
void
freexmessage (xmachine_message ** p_xmessage, xmachine_message * message)
{
 ...
 */
void
freexmessages (xmachine_message ** p_xmessage)
{
...
void
addstateholder (xmachine_state * state, xmachine_state_holder ** p_list)
{
  xmachine_state_holder *current;

  if ((current =
       (xmachine_state_holder *) malloc (sizeof (xmachine_state_holder))) ==
      NULL)
    {
      printf ("Error: Cannot allocate memory\n");
      exit (0);
...
void
freestateholder (xmachine_state_holder ** p_list)
{
 ...
 */
void
addxstate (char *name, char *agent_name, xmachine_state ** p_xstates)
{
  ...
  while (current && flag == 0)
    {
	  ...
	  && strcmp (current->agent_name, agent_name) == 0)
	flag = 1;
  ...
  if (flag == 0)
    {
      /* And current is the new element */
      if ((current =
	   (xmachine_state *) malloc (sizeof (xmachine_state))) == NULL)
	{
	  printf ("Error: Cannot allocate memory\n");
	  exit (0);
	}
 ...
 */
void
freexstates (xmachine_state ** p_xstates)
{
...
void
add_flame_communication (char *messagetype, rule_data * filter_rule,
			 xmachine_function * function1,
			 xmachine_function * function2,
...
void
free_flame_communications (flame_communication ** communications)
{
...
void
add_time_unit (char *name, char *unit_name, int period,
	       time_data ** p_time_units)
{
  ...
  if (strcmp (unit_name, "ITERATION") == 0
      || strcmp (unit_name, "iteration") == 0)
    {
...
void
free_time_units (time_data ** p_time_units)
{
  time_data *temp, *head;
  head = *p_time_units;
...
adj_function *
add_depends_adj_function (xmachine_function * current_function)
{
...
void
add_adj_function_simple (xmachine_function * function1,
			 xmachine_function * function2)
{
  adj_function *current;
...
void
remove_adj_function_simple (xmachine_function * function1)
{
  adj_function *current;
...
void
add_adj_function_recent (xmachine_function * function1,
			 xmachine_function * function2)
{
  adj_function *current;
...
void
remove_adj_function_recent (xmachine_function * function1)
{
  adj_function *current;
...
void
add_adj_function (xmachine_function * function1,
		  xmachine_function * function2, char *type)
{
  adj_function *current;
...
void
free_adj_function (adj_function * adj_functions)
{
...
rule_data *
add_rule_data (rule_data ** p_data)
{
...
void
free_rule_data (rule_data ** p_data)
{
  rule_data *temp, *head;
  head = *p_data;
  /* Loop until new elements of cells left */
...
void
copy_rule_data (rule_data * to, rule_data * from)
{
 ...
 */
xmachine_function *
addxfunction (xmachine_function ** p_xfunctions)
{
  ...
  /* And current is the new element */
  if ((current =
       (xmachine_function *) malloc (sizeof (xmachine_function))) == NULL)
    {
      printf ("Error: Cannot allocate memory\n");
      exit (0);
    }
 ...
 */
void
freexfunctions (xmachine_function ** p_xfunctions)
{
 ...
 */
xmachine *
addxmachine (xmachine ** p_xmachines, char *name)
{
  int number = 0;
 ...
 */
void
freexmachines (xmachine ** p_xmachines)
{
  xmachine *temp, *head;
  head = *p_xmachines;
  /* Loop until new elements of cells left */
 ...
 */
void
addfunction_pointer (function_pointer ** p_function_pointers,
		     xmachine_function * function)
{
  function_pointer *current;

  /* And current is the new element */
  if ((current =
       (function_pointer *) malloc (sizeof (function_pointer))) == NULL)
    {
      printf ("Error: Cannot allocate memory\n");
      exit (0);
    }
 ...
 */
void
freefunction_pointers (function_pointer ** p_function_pointers)
{
 ...
 */
model_datatype *
adddatatype (model_datatype ** p_datatypes)
{
 ...
 */
void
freedatatypes (model_datatype ** p_datatypes)
{
 ...
 */
void
free_int_array (int_array * array)
{
  free (array->array);
  free (array);
}
 ...
 */
void
sort_int_array (int_array * array)
{
  int i, j, temp;
 ...
 */
int
quicksort_int (int *array, int elements)
{
#define  LEVEL  1000
 ...
 */
void
add_int (int_array * array, int new_int)
{
  if (array->size == array->total_size)
    {
      array->total_size = (int) (array->total_size * ARRAY_GROWTH_RATE);
      array->array =
	(int *) realloc (array->array, (array->total_size * sizeof (int)));
    }
 ...
 */
void
remove_int (int_array * array, int index)
{
  int i;
 ...
 */
void
print_int_array (int_array * array)
{
  int i;
  printf ("\n");
 ...
 */
void
free_double_array (double_array * array)
{
  free (array->array);
  free (array);
}
 ...
 */
void
sort_double_array (double_array * array)
{
  int i, j;
  double temp;
 ...
 */
void
add_double (double_array * array, double new_double)
{
  if (array->size == array->total_size)
    {
      array->total_size = (int) (array->total_size * ARRAY_GROWTH_RATE);
      array->array =
	(double *) realloc (array->array,
			    (array->total_size * sizeof (double)));
    }
 ...
 */
void
remove_double (double_array * array, int index)
{
  int i;
 ...
 */
void
print_double_array (double_array * array)
{
  int i;
  printf ("\n");
  for (i = 0; i < array->size; i++)
...
void
reset_char_array (char_array * array)
{
  array->size = 0;
  array->array[0] = '\0';
}
 ...
 */
void
free_char_array (char_array * array)
{
  free (array->array);
  free (array);
}
 ...
 */
void
add_char (char_array * array, char new_char)
{
  if (array->size + 1 == array->total_size)
    {
      array->total_size = (int) (array->total_size * ARRAY_GROWTH_RATE);
      array->array =
	(char *) realloc (array->array, (array->total_size * sizeof (char)));
    }
 ...
 */
char *
copy_array_to_str (char_array * array)
{
 ...
 */
void
remove_char (char_array * array, int index)
{
  int i;
 ...
 */
void
print_char_array (char_array * array)
{
  printf ("%s\n", array->array);
}
...
void
addagent_colour (agent_colour ** p_agent_colours, char *name,
		 int colour_value)
{
//      int number = 0;
 ...
 */
void
freeagent_colours (agent_colour ** p_agent_colours)
{
...
int
displayagent_colour (agent_colour ** p_agent_colours, char *name)
{
...
void
addmodel_colour (model_colour ** p_model_colours, char *name, int colour)
{
  int flag = 0;
...
void
freemodel_colours (model_colour ** p_model_colours)
{
...
int
displaymodel_colour (model_colour ** p_model_colours, char *name)
{
...
int
length_colour (model_colour ** p_model_colours)
{
  int count = 0;
  model_colour *current = *p_model_colours;
