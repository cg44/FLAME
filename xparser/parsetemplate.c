...
void
writeRule (rule_data * current_rule_data, FILE * file, int flag)
{
  char data[100];
  ...
  /* If interaction radius */
      ...
      else if (strcmp (current_rule_data->op, "IN") == 0)
	{
	  ...
	  if (current_rule_data->rhs_variable->arraylength > 0)
	    {
	      sprintf (data, "%i",
		       current_rule_data->rhs_variable->arraylength);
	      fputs (data, file);
	    }
	  fputs (")", file);
	}
      else
	{
	  if (current_rule_data->lhs == NULL)
	    writeRule (current_rule_data->lhs_rule, file, 0);
	  else
	    fputs (current_rule_data->lhs, file);
	  fputs (" ", file);
	  fputs (current_rule_data->op, file);
	  ...
	  if (current_rule_data->rhs == NULL)
	    writeRule (current_rule_data->rhs_rule, file, 0);
	  else
	    fputs (current_rule_data->rhs, file);
	}
      fputs (")", file);
 ...
 */
void
parseTemplate (char *filename, char *templatename, model_data * modeldata)
{
      ...
      if (tmplcode == 1)
	{
	  ...
	  if (c == '>')
	      ...
	      else if (strcmp (buffer->array, "<?if parallel?>") == 0)
		{
	      ...
	      else if (strcmp (buffer->array, "<?if has_arrays_or_adts?>") ==
		       0)
		{
		  strcpy (&chartag[numtag][0], "if");
		  if (write == 1)
		  ...
		  if (current_datatype != NULL)
		    {
		      if (current_datatype->has_arrays_or_adts == 0)
			write = 0;
		    }
		  writetag[numtag] = write;
		}
	      else if (strcmp (buffer->array, "<?if has_arrays?>") == 0)
		{
		  ...
		  if (current_datatype != NULL)
		    {
		      if (current_datatype->has_arrays == 0)
			write = 0;
		    }
		  writetag[numtag] = write;
		}
	      ...
	      else if (strcmp (buffer->array, "<?if modeldatatype?>") == 0)
		{
		  ...
		  if (inallvar)
		    {
		      if (allvar->ismodeldatatype == 0)
			write = 0;
		    }
		  if ((inxagentvar || inmessagevar)
		      && current_variable != NULL)
		    {
		      if (current_variable->ismodeldatatype == 0)
			write = 0;
		    }
		  if (indatatypevar)
		    {
		      if (current_datatypevariable->ismodeldatatype == 0)
			write = 0;
		    }
		  writetag[numtag] = write;
		}
	      else if (strcmp (buffer->array, "<?if not_modeldatatype?>") ==
		       0)
		{
		  if (log)
	      ...
	      else if (strcmp (buffer->array, "<?if float?>") == 0)
		{
		  ...
		  if (strcmp (lastloop, "foreach datatypevar") == 0)
		    {
		      if (indatatypevar)
			if (strcmp (current_datatypevariable->type, "float")
			    != 0
			    && strcmp (current_datatypevariable->type,
				       "char_array") != 0)
			  write = 0;
		    }
		  else
		    {
		      if (inenvvar)
			if (strcmp (current_envvar->type, "float") != 0
			    && strcmp (current_envvar->type,
				       "char_array") != 0)
			  write = 0;
		      if (inallvar)
			if (strcmp (allvar->type, "float") != 0
			    && strcmp (allvar->type, "float_array") != 0)
			  write = 0;
		      if ((inxagentvar || inmessagevar)
			  && current_variable != NULL)
	      ...
	      else if (strcmp (buffer->array, "<?if char?>") == 0)
		{
		  ...
		  if (strcmp (lastloop, "foreach datatypevar") == 0)
		    {
		      if (indatatypevar)
			if (strcmp (current_datatypevariable->type, "char") !=
			    0
			    && strcmp (current_datatypevariable->type,
				       "char_array") != 0)
			  write = 0;
			...
			if (strcmp (current_envvar->type, "char") != 0
			  ...
			  write = 0;
		      if (inallvar)
			if (strcmp (allvar->type, "char") != 0
			    && strcmp (allvar->type, "char_array") != 0)
			  write = 0;
		      if ((inxagentvar || inmessagevar)
			  && current_variable != NULL)
	      ...
	      else if (strcmp (buffer->array, "<?if char_array?>") == 0)
		{
		  ...
		  if ((inxagentvar || inmessagevar)
		    ...
		    if (strcmp (current_variable->type, "char_array") != 0)
		      write = 0;
		  if (indatatypevar)
		    if (strcmp (current_datatypevariable->type, "char_array")
			!= 0
			&& strcmp (current_datatypevariable->type,
				   "char") != 0)
		      write = 0;
	      ...
	      else if (strcmp (buffer->array, "<?if notlast?>") == 0)
		{
		  ...
		  if (strcmp (lastloop, "foreach function") == 0)
			...
			&& current_xmachine->next == NULL)
		      write = 0;
		  if (strcmp (lastloop, "foreach datatypevar") == 0)
		    {
		      if (current_datatypevariable != NULL)
			{
			  if (current_datatypevariable->next == NULL)
			    write = 0;
			}
		      else
			write = 0;
	      ...
	      else if (strcmp (buffer->array, "<?if single_vars?>") == 0)
		{
		  ...
		  if (current_datatype != NULL)
		    {
		      if (current_datatype->has_single_vars == 0)
			write = 0;
		    }
		  writetag[numtag] = write;
		}
	      else if (strcmp (buffer->array, "<?if has_dynamic_arrays?>") ==
		       0)
		{
		  strcpy (&chartag[numtag][0], "if");
		  if (write == 1)
		  ...
		  if (current_datatype != NULL)
		    {
		      if (current_datatype->has_dynamic_arrays == 0)
			write = 0;
		    }
		  writetag[numtag] = write;
		}
	      else if (strcmp (buffer->array, "<?if no_dynamic_arrays?>") ==
		       0)
		{
		  strcpy (&chartag[numtag][0], "if");
		  if (write == 1)
		  ...
		  if (current_datatype != NULL)
		    {
		      if (current_datatype->has_dynamic_arrays == 1)
			write = 0;
		    }
		  writetag[numtag] = write;
		}
		  ...
		  if (current_function != NULL)
		    {
		      ...
		      if (strcmp (current_function->name, "idle") == 0)
			write = 0;
		    }
		  writetag[numtag] = write;
		}
	      ...
	      else if (strcmp (buffer->array, "<?if sync_filter?>") == 0)
		{
		  ...
		  if (current_sync != NULL)
		    {
		      if (current_sync->has_agent_and_message_vars == 0)
			write = 0;
		    }
		  else
		    write = 0;
		  ...
		  if (current_ioput != NULL)
		    {
		      if (current_ioput->filter_rule != NULL)
			{
			  if (current_ioput->filter_rule->has_agent_var == 0)
			    write = 0;
			}
		    }
			...
			{
			  if (current_function->filter_rule->has_agent_var ==
			      0)
			    write = 0;
			}
		      else if (current_function->has_agent_var == 0)
			write = 0;
		    }
		  else if (current_xmachine != NULL)
		    {
		      if (current_xmachine->variables == NULL)
			write = 0;
		    }
		  writetag[numtag] = write;
		}
		  ...
		  if (current_ioput != NULL)
		    {
		      if (current_ioput->filter_rule != NULL)
			{
			  if (current_ioput->filter_rule->has_message_var ==
			      0)
			    write = 0;
			}
		    }
		    ...
		    {
		      if (current_function->has_agent_var == 0)
			write = 0;
		    }
		  writetag[numtag] = write;
		}
	      ...
	      else if (strcmp (buffer->array, "<?if descend?>") == 0)
		{
		  ...
		  if (current_ioput != NULL)
		    {
		      if (current_ioput->sort_order != NULL)
			if (strcmp (current_ioput->sort_order, "descend") !=
			    0)
			  write = 0;
		    }
	      ...
	      else if (strcmp (buffer->array, "<?if constant?>") == 0)
		{
		  ...
		  if (write == 1)
		    lastiftag = numtag;
		  numtag++;
		  if (current_variable->constant == 0)
		    write = 0;
		  writetag[numtag] = write;
		}
	      else if (strcmp (buffer->array, "<?if tree2d?>") == 0)
		{
		  ...
		  if (current_message != NULL)
		    {
		      if (current_message->has_box2d == 0)
			write = 0;
		    }
		  if (current_sync != NULL)
		    {
		      if (current_sync->message->has_box2d == 0)
			write = 0;
		    }
		  if (current_ioput != NULL)
		    {
	      ...
	      else if (strcmp (buffer->array, "<?if tree3d?>") == 0)
		{
		  ...
		  if (current_message != NULL)
		    {
		      if (current_message->has_box3d == 0)
			write = 0;
		    }
		  if (current_sync != NULL)
		    {
		      if (current_sync->message->has_box3d == 0)
			write = 0;
		    }
		  if (current_ioput != NULL)
		    {
	      ...
	      else if (strcmp (buffer->array, "<?if make_x_func?>") == 0)
		{
		  ...
		  if (current_message != NULL)
		    {
		      if (current_message->make_x_function == 0)
			write = 0;
		    }
		  writetag[numtag] = write;
		}
	      else if (strcmp (buffer->array, "<?if make_y_func?>") == 0)
		{
		  ...
		  if (current_message != NULL)
		    {
		      if (current_message->make_y_function == 0)
			write = 0;
		    }
		  writetag[numtag] = write;
		}
	      else if (strcmp (buffer->array, "<?if make_z_func?>") == 0)
		{
		  ...
		  if (current_message != NULL)
		    {
		      if (current_message->make_z_function == 0)
			write = 0;
		    }
		  writetag[numtag] = write;
		}
	      ...
	      else if (strcmp (buffer->array, "<?end foreach?>") == 0)
		{
		  ...
		  if (strcmp
		    ...
		    if (strcmp ("foreach functionfiles", &chartag[numtag][0])
			== 0)
		    {
		  ...
		  else if (strcmp ("foreach allvar", &chartag[numtag][0]) ==
			   0)
		    {
		      if (allvar != NULL)
			{
		  ...
		  else if (strcmp ("foreach envvar", &chartag[numtag][0]) ==
			   0)
		    {
		      ...
		      else
			{
			  ...
			  numtag++;
			   ...
			   || strcmp ("foreach readingxagent",
				      &chartag[numtag][0]) == 0
			   || strcmp ("foreach sendingxagent",
				      &chartag[numtag][0]) == 0)
		    {
		  ...
		  else if (strcmp ("foreach xagentvar", &chartag[numtag][0])
			   == 0)
		    {
		      if (current_variable != NULL)
			{
		  ...
		  else if (strcmp ("foreach message", &chartag[numtag][0]) ==
			   0)
		    {
		      if (current_message != NULL)
			{
		  ...
		  else if (strcmp ("foreach messagevar", &chartag[numtag][0])
			   == 0)
		    {
		      if (current_variable != NULL)
			{
		  ...
		  else if (strcmp ("foreach syncvar", &chartag[numtag][0]) ==
			   0)
		    {
		      if (current_variable != NULL)
			{
		  ...
		  else if (strcmp ("foreach paramvar", &chartag[numtag][0]) ==
			   0)
		    {
		      if (current_variable != NULL)
			{
		    ...
		    if (strcmp ("foreach function_input", &chartag[numtag][0])
			== 0)
		    {
		      if (current_ioput != NULL)
			{
			  ...
			  if (current_sync != NULL)
			    {
			      while (current_ioput != NULL &&
				     strcmp (current_ioput->messagetype,
					     current_sync->message->name) !=
				     0)
				{
				  current_ioput = current_ioput->next;
				}
		    ...
		    if (strcmp
			("foreach function_output", &chartag[numtag][0]) == 0)
		    {
		      if (current_ioput != NULL)
			current_ioput = current_ioput->next;
		      if (current_ioput == NULL)
		    ...
		    if (strcmp ("foreach complete_sync", &chartag[numtag][0])
			== 0)
		    {
		  ...
		  else if (strcmp ("foreach start_sync", &chartag[numtag][0])
			   == 0)
		    {
		      if (current_sync_pointer != NULL)
			current_sync_pointer = current_sync_pointer->next;
		  ...
		  else if (strcmp ("foreach function", &chartag[numtag][0]) ==
			   0)
		    {
		      if (current_layer != NULL)
			{	// || current_sync != NULL)
		  ...
		  else if (strcmp ("foreach enditfunc", &chartag[numtag][0])
			   == 0)
		    {
		  ...
		  else if (strcmp ("foreach datatype", &chartag[numtag][0]) ==
			   0)
		    {
		      if (current_datatype != NULL)
		  ...
		  else if (strcmp ("foreach datatypevar", &chartag[numtag][0])
			   == 0)
		    {
		      if (current_datatypevariable != NULL)
			current_datatypevariable =
			  current_datatypevariable->next;
		      if (current_datatypevariable == NULL)
			{
			  exitforeach = 1;
			  indatatypevar = 0;
		  ...
		  else if (strcmp ("foreach timeunit", &chartag[numtag][0]) ==
			   0)
		    {
		  ...
		  else if (strcmp ("foreach endstate", &chartag[numtag][0]) ==
			   0)
		    {
		    ...
		    if (strcmp
			("foreach branching_state", &chartag[numtag][0]) == 0)
		    {
		      if (current_end_state != NULL)
			{
			  current_end_state = current_end_state->next;
		...
		if (strcmp
		    (buffer->array,
		     "<?foreach constant_filter_variable?>") == 0)
		{
		  if (log)
		    printf
		      ("start :%d\tforeach constant_filter_variable\tpos: %d\n",
		       numtag, pos);
		  strcpy (&chartag[numtag][0],
			  "foreach constant_filter_variable");
	      ...
	      else if (strcmp (buffer->array, "<?foreach functionfiles?>") ==
		       0)
		{
		  if (log)
	      ...
	      else if (strcmp (buffer->array, "<?foreach xagent?>") == 0)
		{
	      ...
	      else if (strcmp (buffer->array, "<?foreach sendingxagent?>") ==
		       0)
		{
		  if (log)
	      ...
	      else if (strcmp (buffer->array, "<?foreach readingxagent?>") ==
		       0)
		{
		  if (log)
	      ...
	      else if (strcmp (buffer->array, "<?foreach state?>") == 0)
		{
	      ...
	      else if (strcmp (buffer->array, "<?foreach function_input?>") ==
		       0)
		{
		  if (log)
	      ...
	      else if (strcmp (buffer->array, "<?foreach function_output?>")
		       == 0)
		{
		  if (log)
	      ...
	      else if (strcmp (buffer->array, "<?foreach complete_sync?>") ==
		       0)
		{
		  if (log)
	      ...
	      else if (strcmp (buffer->array, "<?foreach start_sync?>") == 0)
		{
		  ...
		  /*lastwrite = write; */
		  if (current_function != NULL)
		    current_sync_pointer = current_function->start_syncs;
		  else
		    current_sync_pointer = NULL;
		  if (current_sync_pointer == NULL)
		    write = 0;
		  else
		    current_sync = current_sync_pointer->current_sync;
	      ...
	      else if (strcmp (buffer->array, "<?foreach message?>") == 0)
		{
		  ...
		  if (current_layer != NULL)
		    current_message = current_layer->finished_messages;
		  else
	      ...
	      else if (strcmp (buffer->array, "<?foreach syncvar?>") == 0)
		{
		  ...
		  if (current_sync != NULL)
		    current_variable = current_sync->vars;
		  else
		    current_variable = NULL;
		  if (current_variable == NULL)
		    write = 0;
	      ...
	      else if (strcmp (buffer->array, "<?foreach function?>") == 0)
		{
		  ...
		  if (strcmp (lastloop, "foreach sync") == 0)
		  ...
		  else if (strcmp (lastloop, "foreach branching_state") == 0)
		    {
		      ...
		      if (current_end_state != NULL)
			current_function_pointer =
			  current_end_state->state->outgoing_functions;
		      else
			current_function_pointer = NULL;
		      if (current_function_pointer == NULL)
			write = 0;
	      ...
	      else if (strcmp (buffer->array, "<?foreach datatypevar?>") == 0)
		{
		  ...
		  if (current_datatype != NULL)
		    current_datatypevariable = current_datatype->vars;
		  if (current_datatypevariable == NULL)
		    {
		      write = 0;
		      indatatypevar = 0;
	      ...
	      else if (strcmp (buffer->array, "<?foreach endstate?>") == 0)
		{
	      ...
	      else if (strcmp (buffer->array, "<?foreach branching_state?>")
		       == 0)
		{
		  if (log)
      ...
      else
	{
	  ...
	  if (c == '$' && write == 1)
		     ...
		     && pos <= (pos1 + 24) && pos <= filebuffer->size)
		{
	      ...
	      pos--;
	      if (strcmp (buffer3->array, "$model_name") == 0)
		fputs (modeldata->name, file);
	      else if (strcmp (buffer3->array, "$number_messagesplusone") ==
		       0)
		{
	      ...
	      else
		{
		  ...
		  if (strcmp ("foreach constant_filter_variable", lastloop) ==
		      0)
		    {
			...
			fputs (current_variable->agent->start_state->name,
			       file);
		      else
			{
			  fputs ("$", file);
		    ...
		    {
		      while (strcmp (buffer3->array, "$name") != 0
			     && strcmp (buffer3->array, "$type") != 0
			     && strcmp (buffer3->array, "$default_value") != 0
			     && strcmp (buffer3->array, "$c_type") != 0
			     && strcmp (buffer3->array, "$notarraytype") != 0
			     && strcmp (buffer3->array, "$arraylength") != 0
			     && pos <= (pos1 + 14))
			{
			  add_char (buffer3, c);
			  pos++;
		  ...
		  else if (strcmp ("foreach envvar", lastloop) == 0)
		    {
		      while (strcmp (buffer3->array, "$name") != 0
			     && strcmp (buffer3->array, "$type") != 0
			     && strcmp (buffer3->array, "$uc_name") != 0
			     && strcmp (buffer3->array, "$default_value") != 0
			     && strcmp (buffer3->array, "$c_type") != 0
			     && pos <= (pos1 + 14))
			{
		    ...
		    {
		      while (strcmp (buffer3->array, "$filepath") != 0
			     && pos <= (pos1 + 9))
			{
			  add_char (buffer3, c);
			  pos++;
			   ...
			   strcmp ("foreach readingxagent", lastloop) == 0)
		    {
		      while (strcmp (buffer3->array, "$name") != 0 &&
			     ...
			     strcmp (buffer3->array,
				     "$xagentcountplusone") != 0
		      ...
		      else if (strcmp (buffer3->array, "$var_number") == 0)
			{
		      ...
		      else if (strcmp (buffer3->array, "$xagentcountplusone")
			       == 0)
			{
			...
			{
			  if (current_sync->inputting_functions == NULL)
			    fputs ("unknown", file);
			  else
			    {
			      sprintf (data, "%i",
		  ...
		  else if (strcmp ("foreach xagentvar", lastloop) == 0)
		    {
		      while (strcmp (buffer3->array, "$name") != 0
			     ...
			     && strcmp (buffer3->array, "$agent_name") != 0
			     && strcmp (buffer3->array, "$c_type") != 0
			     && strcmp (buffer3->array, "$mpi_type") != 0
			     && strcmp (buffer3->array, "$arraylength") != 0
			     && strcmp (buffer3->array, "$var_count") != 0
			     && strcmp (buffer3->array, "$notarraytype") != 0
			     && strcmp (buffer3->array, "$default_value") != 0
			     && pos <= (pos1 + 15))
			{
			   ...
			   strcmp ("foreach function_output", lastloop) == 0)
		    {
		      while (strcmp (buffer3->array, "$name") != 0
			     && strcmp (buffer3->array, "$agent_name") != 0
			     && strcmp (buffer3->array, "$filter") != 0
			     && strcmp (buffer3->array, "$rule") != 0
			     && strcmp (buffer3->array, "$sort") != 0
			     && strcmp (buffer3->array, "$box") != 0
			     && strcmp (buffer3->array, "$key") != 0
			     && pos <= (pos1 + 15))
			{
			  add_char (buffer3, c);
			  pos++;
		  ...
		  else if (strcmp ("foreach message", lastloop) == 0)
		    {
		      while (strcmp (buffer3->array, "$name") != 0
			     && strcmp (buffer3->array, "$var_number") != 0
			     && strcmp (buffer3->array,
					"$message_countplusone") != 0
			     && strcmp (buffer3->array, "$previous_name") != 0
			     && strcmp (buffer3->array, "$capsname") != 0
			     && pos <= (pos1 + 22))
			{
			  add_char (buffer3, c);
			  pos++;
			...
			if (strcmp (buffer3->array, "$message_countplusone")
			    == 0)
			{
		      ...
		      else if (strcmp (buffer3->array, "$layer") == 0)
			{
		      ...
		      else if (strcmp (buffer3->array, "$filteragentcount") ==
			       0)
			{
			  sprintf (data, "%i",
		    ...
		    {
		      while (strcmp (buffer3->array, "$name") != 0
			     && strcmp (buffer3->array, "$note") != 0
			     && strcmp (buffer3->array, "$agent_name") != 0
			     && strcmp (buffer3->array, "$current_state") != 0
			     && strcmp (buffer3->array, "$next_state") != 0
			     && strcmp (buffer3->array, "$condition") != 0
			     && strcmp (buffer3->array, "$message_name") != 0
			     && strcmp (buffer3->array, "$layer") != 0
		      ...
		      else if (strcmp (buffer3->array, "$condition") == 0)
			{
			  if (current_function->condition_function == NULL)
			    ...
			    fputs (current_function->condition_function,
				   file);
			}
		      else if (strcmp (buffer3->array, "$rule") == 0)
			{
		    ...
		    {
		      while (strcmp (buffer3->array, "$code") != 0
			     && pos <= (pos1 + 5))
			{
			  add_char (buffer3, c);
			  pos++;
		    ...
		    {
		      while (strcmp (buffer3->array, "$name") != 0
			     && strcmp (buffer3->array, "$unit_name") != 0
			     && strcmp (buffer3->array, "$period") != 0
			     && pos <= (pos1 + 11))
			{
			  add_char (buffer3, c);
			  pos++;
		      ...
		      else if (strcmp (buffer3->array, "$unit_name") == 0)
			{
			  if (current_time_unit->unit == NULL)
			    fputs ("ITERATION", file);
			  else
			    fputs (current_time_unit->unit->name, file);
			}
		      else if (strcmp (buffer3->array, "$period") == 0)
			{
			  if (current_time_unit->unit != NULL)
			    {
			      sprintf (data, "%i",
				       current_time_unit->period *
				       current_time_unit->unit->period);
			      fputs (data, file);
			    }
			  else
			    fputs ("ITERATION", file);
			...
			fputs (current_datatypevariable->name, file);
		      else if (strcmp (buffer3->array, "$datatypevarname") ==
			       0)
			{
			  if (inallvar)
			    fputs (allvar->name, file);
			...
			{
			  sprintf (data, "%i",
				   current_datatypevariable->arraylength);
			  fputs (data, file);
			}
		      else if (strcmp (buffer3->array, "$var_count") == 0)
			{
		    ...
		    {
		      while (strcmp (buffer3->array, "$number") != 0
			     && pos <= (pos1 + 16))
			{
			  add_char (buffer3, c);
			  pos++;
 ...
 */
void
parseAgentHeaderTemplate (char *directory, model_data * modeldata)
{
  FILE *file;
  char filename[1000];
  char buffer[1000];
...
void
parseUnittest (char *directory, model_data * modeldata)
{
  FILE *file;
  char filename[100];
  /*xmachine * current_xmachine = * modeldata->p_xmachines;
...
void
parser0xsd (char *directory, model_data * modeldata)
{
  FILE *file;
  char filename[100];
  /*xmachine * current_xmachine = * modeldata->p_xmachines; */
...
void
parser0dtd (char *directory, model_data * modeldata)
{
  FILE *file;
  char filename[100];
  /*xmachine * current_xmachine = * modeldata->p_xmachines; */
  ...
  fputs
    ("<!ELEMENT states (itno?,imports?,outputs?,environment?,xagents?)>\n",
     file);
