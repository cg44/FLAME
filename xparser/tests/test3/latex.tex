...
\title{test_truncated_empty_xml_tags Reference Manual}
...
\section{test_truncated_empty_xml_tags FLAME Implementation}

\subsection{a}

\begin{longtable}[H!]{ll}
\caption{{\bfseries List of memory variables for a agent.}}
\label{Table: a Memory}\\
\toprule 
...
\end{longtable}
\begin{longtable}[H!]{ll}
\caption{{\bfseries List of functions for a agent.}}
\label{Table: a Functions}\\
\toprule 
\bfseries Name & \bfseries Description \\ \hline 
\midrule
\endfirsthead
